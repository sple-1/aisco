package aisco.product.withoutdonation; 
...
ProgramFactory.createProgram( 
            ...
            "100 students", 
            "Government", 
            "https://www.myschool.spelive.id/logo" 
        ); 
        Program freeLibrary = ProgramFactory.createProgram( 
            ...
            "children", 
            "BeriBuku Community", 
            "https://www.myschool.spelive.id/liblogo" 
        ); 
        Program paymentElectricity = 
ProgramFactory.createProgram( 
    ...
    public static List<FinancialReport> 
addIncome(List<Program> programs) { 
...
"aisco.financialreport.core.FinancialReportImpl", 
    ...
    public static List<FinancialReport> 
addExpense(List<Program> programs) { 
...
"aisco.financialreport.core.FinancialReportImpl", 
    ...
    public static void main(String[] args) { 
        System.out.println("Product Without Donation"); 
        ...
        int totalIncome = 
((aisco.financialreport.income.FinancialReportImpl) 
income1).total(incomes); 
         
        List<FinancialReport> expenses = 
addExpense(programs); 
        expense1.printHeader(); 
        System.out.println(expenses); 
        int totalExpense = 
((aisco.financialreport.expense.FinancialReportImpl) 
expense1).total(expenses); 
