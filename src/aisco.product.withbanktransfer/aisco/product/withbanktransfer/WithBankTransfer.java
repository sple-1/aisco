package aisco.product.withbanktransfer;
...
public class WithBankTransfer {
    ...
    public static void addDonation() {
        Donation donate = DonationFactory.createDonation("aisco.donation.banktransfer.DonationImpl");
        donate.addDonation();
        donate.getDonation();
    }
